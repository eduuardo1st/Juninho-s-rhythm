...
int pontuacao1 = 0;
int erros1;
BarraTecla barrasTeclas1[4]; // Declara��o do array de barras
Nota *listaNotas1; // Cabe�a da lista encadeada de notas
Nota notas1[10];
...
erros1 = 0; // Adicione uma vari�vel global para erros

bool jogoEncerrado = false; // Vari�vel de controle para o estado do jogo
